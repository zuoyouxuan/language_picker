...
class Languages {
  ...
  static Language get chineseSimplified => Language('zh_Hans', 'Chinese (Simplified)');
  static Language get chineseTraditional => Language('zh_Hant', 'Chinese (Traditional)');
  ...
  static Language get tongaTongaIslands => Language('to', 'Tonga (Tonga Islands)');
